  ...
  return (
    <div className="flex md:px-1 py-4 md:hover:bg-gray-100 rounded-lg">
      <div className="flex-none md:w-28 md:h-28 w-22 w-22 md:mr-4 mr-3">
        <Img src={getImageUrl(podcast?.urlParam || searchResult?.urlParam)} />
      </div>

      <div>
        <div className="md:text-base text-sm text-black font-semibold tracking-wide line-clamp-2">
          <PodcastLink
            podcastUrlParam={podcast?.urlParam || searchResult?.urlParam}
          >
            <a
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html:
              searchResult?.authorHighlighted ||
              searchResult?.author ||
              podcast?.author,
          }}
        />
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html:
              searchResult?.descriptionHighlighted ||
